...
public class BrandRepository : IBrandRepository
{
    ...
    public BrandRepository(IDBContext dbContext, IFileUploader uploader)
    {
    ...
    private static string? UrlParse(string fileName, string brandId, string hostUrl)
    {
        var uri = UrlParser.Parse(hostUrl, brandId, fileName);
