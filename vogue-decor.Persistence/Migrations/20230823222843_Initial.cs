        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Colors = table.Column<int[]>(type: "integer[]", nullable: true),
                    ...
                    ChandelierTypes = table.Column<int[]>(type: "integer[]", nullable: true),
                    Plinth = table.Column<string>(type: "text", nullable: false),
                    LampCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTypes_SearchVector",
                table: "ProductTypes",
                column: "SearchVector")
                .Annotation("Npgsql:IndexMethod", "GIN");

            migrationBuilder.CreateIndex(
                name: "IX_ProductUsers_Id",
                table: "ProductUsers",
                column: "Id",
                unique: true);
